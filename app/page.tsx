...
export default async function EPK() {
  ...
  return (
    <main className="min-h-screen bg-[#F5F2ED] text-[#8B6B4A]"
      ...
      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-6 py-4 md:py-5">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-12 z-10">
          <a href="#">
            <h1 className="fade-up fade-up-2 text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-none text-center mb-3 hover:opacity-70 transition-opacity drop-shadow-md" style={{ color: "#8B6B4A" }}>
              Michael Cantor
            </h1>
          </a>
      ...
      {/* ── BIO ── */}
      <section id="bio" className="py-16 md:py-24 px-6 md:px-20 max-w-5xl mx-auto text-center">
        <div className="flex flex-col items-center gap-8 md:gap-12">
          <div className="relative w-full max-w-sm aspect-[3/4] rounded-2xl overflow-hidden mx-auto">
            <Image src="/bio-photo.jpg" alt="Michael Cantor" fill className="object-cover object-top" />
          </div>
          <div className="space-y-5 text-[#8B6B4A] leading-relaxed text-[15px] max-w-2xl mx-auto">
      ...
      {/* ── LIVE PERFORMANCES ── */}
      <section id="live" className="py-16 md:py-24 px-6 md:px-20 max-w-5xl mx-auto text-center">
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="py-16 md:py-24 px-6 md:px-20 max-w-5xl mx-auto text-center">
